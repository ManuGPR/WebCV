  ...
  return (
    <div className='min-h-[70vh]'>
      ...
      <div className='grid grid-cols-1 place-items-center w-screen m-auto'>
        <Button onClick={() => {window.open("/CV.pdf", '_blank');}} className='bg-blue-500 w-1/3 py-2 mb-2'>
          <p className='text-xl'>
            Ver Curriculum en Español
          </p>
        </Button>
        <Button onClick={() => {window.open("/CV_ENG.pdf", '_blank');}} className='bg-blue-500 w-1/3 py-2'>
          <p className='text-xl'>
